...
const Pagination = () => {
    ...
    return (
        <section className="pagination">
            <button data-testid="back-page-btn" onClick={() => changePage(currentPage - 1)} className={`paginate-item ${currentPage === 1 && "cursor-disabled"}`}>
            ...
            <div data-testid="page-buttons" className="paginate-content">
                {
            ...
            <button data-testid="next-page-btn" onClick={() => changePage(currentPage + 1)} className={`paginate-item ${currentPage === totalPage && "cursor-disabled"}`}>
                <svg width="5" height="5" viewBox="0 0 5 5" fill="#646464" xmlns="http://www.w3.org/2000/svg">
